      ...
      >
        <Card className="p-8 border-brand-100/50">
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1">Start practicing and tracking your progress</p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" fullWidth disabled={loading} loading={loading} icon={<UserPlus className="w-4 h-4" />} variant="gradient">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link to="/login" className="text-brand-600 font-semibold hover:text-brand-700 hover:underline transition-fast">
              Sign In
            </Link>
          </p>
        </Card>
